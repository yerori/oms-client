...
function fnSearch(){		
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "OmsPsoMapper.SELECT_PSO_DEPT_PRO_RATE" ,"dsSearch" , "dsPsoDeptList");	//조회만
	TRN.gfnCommonTransactionAddSearch(this.screen , "OmsPsoMapper.SELECT_PSO_DEPT_PRO" ,"dsSearch" , "dsPsoList");	//조회만	
