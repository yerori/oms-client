...
{ 
	var iRow = this.dsSearch.getpos();
	if (UT.gfnGetAryHashCount(aryHash) != 0) {
		this.dsSearch.setdatabyname(iRow , "PSO_DEPT_CODE" , aryHash["DEPT_CODE"]);
		this.dsSearch.setdatabyname(iRow , "PSO_DEPT_NAME" , aryHash["DEPT_NAME"]);
...
function fnChgPopupCall(chgID, chgName) {
