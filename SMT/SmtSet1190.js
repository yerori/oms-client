...
function fnSaveData()
{
	...
	TRN.gfnCommonTransactionAddUpdate(this.screen , "ProcSmtMapper.UPDATE_SMT_OFFICIA_RECEIVE" , "dsMaster" );	
	//추가후 재조회 실행						
...
function btnCommonSearch_on_mouseup(objInst)
{
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "ProcSmtMapper.SELECT_OFFICIAL_MSTR_RECEIVE" ,"dsSearch" , "dsMaster", "TR_MASTER_INFO");	//조회만	
...
//	if (this.grdMaster.getcolumnname(nColumn) == "CHECK_FLAG") {  
//	   var V_CHECK_FLAG = this.dsMaster.getdatabyname(this.dsMaster.getpos(),"CHECK_FLAG");
//	   var V_RECEIVE_FLAG = this.dsMaster.getdatabyname(this.dsMaster.getpos(),"RECEIVE_FLAG");
//	
//	   if ( V_CHECK_FLAG =="Y" ) {
//		    if ( V_RECEIVE_FLAG =="N" ) {  
...
//				
//				this.dsMaster.setdatabyname(this.dsMaster.getpos(), "RECEIVE_DATE", dateE );
//				this.dsMaster.setdatabyname(this.dsMaster.getpos(), "RECEIVE_USER_ID", INI.GV_USER_ID);
//				this.dsMaster.setdatabyname(this.dsMaster.getpos(), "RECEIVE_NAME", INI.GV_USER_ID_NM );					
//		     } 
//	     }
//	}
