...
function fnPageSet(){
	...
	if (objExtraData !== null) {
		...
		// 초기값 설정
		this.dsSearch.setdatabyname(0, "GRP_CODE", objExtraData.P_DATA1);
		this.dsSearch.setdatabyname(0, "GRP_NAME", objExtraData.P_DATA2);
		this.dsSearch.setdatabyname(0, "ITEM_CODE", objExtraData.P_DATA3);
		this.dsSearch.setdatabyname(0, "ITEM_NAME", objExtraData.P_DATA4);
	}
...
function btnSearch_on_mouseup(objInst){
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "systemMapper.SELECT_GRP_ITEM_CODE" ,"dsSearch" , "dsList");	//조회만	
