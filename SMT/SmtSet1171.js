...
function btnSearch_on_mouseup(objInst){
	/*
	0TRN.gfnTranDataSetHandle(this.screen , this.dsSearch , "ALL" , "NONE");	//데이터셋 인:ALL 아웃:NONE 정의
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "ProcSmtMapper.SELECT_F040_POP" ,"dsSearch" , "dsList");	//조회만	
