...
function grdList_on_itemclick(objInst, nClickRow, nClickColumn, bBtnClick, nImgIndex, strImgUrl)
{
   ...
   // var params = "AUTH_CODE="+AUTH_CODE+" OU_CODE="+OU_CODE;
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "OmsAuthMapper.SELECT_AUTH" , "dsAuthSearch" , "dsAuthList");
...
/*    for(var i=0;i<this.dsList.getrowcount();i++){
	...
	TRN.gfnCommonTransactionAddSave(this.screen , "OmsAuthMapper.INSERT_AUTH" , "OmsAuthMapper.UPDATE_AUTH" , "OmsAuthMapper.DELETE_AUTH", "dsAuthList" );	
	//추가후 재조회 실행						
