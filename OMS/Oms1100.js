...
function fnInvalidSearch() {
	...
	var aryDual = [ "PROJECT_CODE", "CHARGE_USER_ID", "TRANSFER_DATE"];
...
function fnSearch(){		
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "OmsProjectMapper.SELECT_PROJECT_BY_CHARGE_USER_CHANGE" ,"dsSearch" , "dsList");
...
function btnChargeUserPop_on_click(objInst, searchName) {
	var strPopupName = UT.gfnGetMetaData("", "수주활동관리 담당자 조회"); 
	objPopupExtraData.clear();
	objPopupExtraData.P_DATA1 = ouCode;
