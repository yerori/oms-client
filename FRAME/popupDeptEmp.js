...
function btnSearch_on_mouseup(objInst){
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "HrCommonMapper.SELECT_USER_HRMSTR_POP" ,"dsSearch" , "dsList");	//조회만	
...
function btnApply_on_mouseup(objInst){
    ...
    if (this.dsList.getdatabyname(this.dsList.getpos(), "T_TYPE") !== "EMP"){
	   UT.alert(screen , "" , "임직원을 선택 바랍니다.");
	   return;
    }
