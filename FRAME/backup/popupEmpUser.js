/*------------------------------------
* program id : popupEmpUser
* desc	   : 직원(사용자등록기준)정보 팝업
* dev date   : 2023-07-06
* made by	: SEYUN
*-------------------------------------*/
...
function fnDsSearchSet(){
	...
	this.fldEmploymentFlag.settext("Y");
}
...
function btnSearch_on_mouseup(objInst){
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "OmsCommonMapper.SELECT_USER_INSA_MSTR_POP" ,"dsSearch" , "dsList");	//조회만	
...
function edtEmpName_on_keydown(objInst, keycode, bctrldown, bshiftdown, baltdown, bnumpadkey)
{
