...
function fnDsSearchSet(){
	...
	UT.gfnGetCommCodes(this.dsBizDiv, "P012");		    // 담당업무 set
	UT.gfnGetCommCodes(this.dsBizDiv, "P012");		    // 담당업무 set
}
...
function btnSearch_on_mouseup(objInst){
	var searchName = this.dsSearch.getdatabyname(0, "USER_NAME");
	var sqlName = searchName ? "OmsCommonMapper.SELECT_CHARGE_POP_NON_USER" : "OmsCommonMapper.SELECT_CHARGE_POP";
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , sqlName ,"dsSearch" , "dsList");	//조회만	
