...
function tr_select_code_ou(){
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "OmsCommonMapper.SELECT_CODE_OU" ,"" , "dsCode_OU", "TR_SELECT_CODE_OU");	// HrCommonMapper -> OmsMapper로 변경 edited by.yelee
	//TRN.gfnCommonTransactionAddSearch(this.screen , "HrCommonMapper.SELECT_CODE_OU" ,"" , "dsCode_OU", "TR_SELECT_CODE_OU"); 
...
function tr_select_code_site(){
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "OmsCommonMapper.SELECT_CODE_SITE" ,"dsSearch" , "dsCode_SITE", "TR_SELECT_CODE_SITE");	// HrCommonMapper -> OmsMapper로 변경 edited by.yelee
	//TRN.gfnCommonTransactionAddSearch(this.screen , "HrCommonMapper.SELECT_CODE_SITE" ,"dsSearch" , "dsCode_SITE", "TR_SELECT_CODE_SITE"); 
...
function btnSearch_on_mouseup(objInst){
		...
		TRN.gfnCommonTransactionAddSearch(this.screen , "OmsCommonMapper.SELECT_EHR_DEPT_POP3" ,"dsSearch" , "dsMaster");	// HrCommonMapper -> OmsMapper로 변경 edited by.yelee
		//TRN.gfnCommonTransactionAddSearch(this.screen , "HrCommonMapper.SELECT_EHR_DEPT_POP3" ,"dsSearch" , "dsMaster");	
