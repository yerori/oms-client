...
function fnDsSearchSet(){
	...
	UT.gfnGetCommCodes(this.dsChgDept, "P003");		    // 업체담당자부서 set
}
...
function btnSearch_on_mouseup(objInst){
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "ProcCommonMapper.SELECT_SUPPLIER_CHG_POP" ,"dsSearch" , "dsList");	//조회만	
