...
function fnDsSearchSet(){
	...
	this.chkUserRegFlag.settext("Y");
	this.edtVendorName.setfocus(true);
}
...
function fnPageSet(){
	...
	if (objExtraData !== null) {
		...
		this.dsSearch.setdatabyname(0, "VENDOR_CODE", objExtraData.P_DATA2);
		this.dsSearch.setdatabyname(0, "VENDOR_NAME", objExtraData.P_DATA3);
...
function btnSearch_on_mouseup(objInst){
	...
	TRN.gfnCommonTransactionAddSearch(this.screen , "ProcCommonMapper.SELECT_SUPPLIER_POP" ,"dsSearch" , "dsList");	//조회만	
...
{
	this.dsSearch.setdatabyname(0, "VENDOR_CODE", "");
	this.dsSearch.setdatabyname(0, "VENDOR_NAME", "");
	this.dsSearch.setdatabyname(0, "BIZ_TYPE", "");
//    if (authScope == "DEPT"){
//		this.dsSearch.setdatabyname(0, "DEPT_CODE", "");
//        this.dsSearch.setdatabyname(0, "DEPT_NAME", "");
//		this.dsSearch.setdatabyname(0, "EMP_NO", "");
//		this.dsSearch.setdatabyname(0, "EMP_NAME", "");			
//	}	
//	if (authScope == "EMP"){	
//		this.dsSearch.setdatabyname(0, "EMP_NO", "");
//		this.dsSearch.setdatabyname(0, "EMP_NAME", "");				
