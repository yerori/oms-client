...
*/
function fnPageSet(){
	UT.gfnHrEditorStyle(this.fldLoginID, "D");
	UT.gfnHrEditorStyle(this.fldUserName, "D");
	UT.gfnHrEditorStyle(this.fldUserID, "D");
	UT.gfnHrEditorStyle(this.fldVendorName, "D");
	UT.gfnHrEditorStyle(this.fldEmpNo, "D");
	UT.gfnHrEditorStyle(this.fldOuName, "D");
	UT.gfnHrEditorStyle(this.fldEmailAddr, "D");
}
